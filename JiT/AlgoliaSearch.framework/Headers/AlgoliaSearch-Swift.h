...
SWIFT_CLASS("_TtC13AlgoliaSearch14AbstractClient")
...
SWIFT_CLASS("_TtC13AlgoliaSearch13AbstractQuery")
...
+ (void)parse:(NSString * _Nonnull)queryString into:(AbstractQuery * _Nonnull)query;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
/// Build a plain, comma-separated array of strings.
+ (NSString * _Nullable)buildStringArray:(NSArray<NSString *> * _Nullable)array SWIFT_WARN_UNUSED_RESULT;
+ (NSArray<NSString *> * _Nullable)parseStringArray:(NSString * _Nullable)string SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nullable)buildJSONArray:(NSArray * _Nullable)array SWIFT_WARN_UNUSED_RESULT;
+ (NSArray * _Nullable)parseJSONArray:(NSString * _Nullable)string SWIFT_WARN_UNUSED_RESULT;
@end
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC13AlgoliaSearch14AsyncOperation")
...
SWIFT_CLASS("_TtC13AlgoliaSearch28AsyncOperationWithCompletion")
@interface AsyncOperationWithCompletion : AsyncOperation
/// User completion block to be called.
@property (nonatomic, readonly, copy) void (^ _Nullable completion)(NSDictionary<NSString *, id> * _Nullable, NSError * _Nullable);
/// Operation queue used to execute the completion handler.
@property (nonatomic, weak) NSOperationQueue * _Nullable completionQueue;
- (nonnull instancetype)initWithCompletionHandler:(void (^ _Nullable)(NSDictionary<NSString *, id> * _Nullable, NSError * _Nullable))completionHandler OBJC_DESIGNATED_INITIALIZER;
- (void)start;
/// Finish this operation.
/// This method should be called exactly once per operation.
- (void)callCompletionWithContent:(NSDictionary<NSString *, id> * _Nullable)content error:(NSError * _Nullable)error;
- (void)_callCompletionWithContent:(NSDictionary<NSString *, id> * _Nullable)content error:(NSError * _Nullable)error;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end


/// An asynchronous operation whose body is specified as a block.
SWIFT_CLASS("_TtC13AlgoliaSearch19AsyncBlockOperation")
@interface AsyncBlockOperation : AsyncOperationWithCompletion
/// Start this request.
- (void)start;
- (nonnull instancetype)initWithCompletionHandler:(void (^ _Nullable)(NSDictionary<NSString *, id> * _Nullable, NSError * _Nullable))completionHandler SWIFT_UNAVAILABLE;
@end
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC13AlgoliaSearch14BrowseIterator")
...
SWIFT_CLASS("_TtC13AlgoliaSearch6Client")
...
/// Used in geo-search.
SWIFT_CLASS("_TtC13AlgoliaSearch7GeoRect")
...
SWIFT_PROTOCOL("_TtP13AlgoliaSearch10Searchable_")
@protocol Searchable
/// Perform a search.
...
SWIFT_CLASS("_TtC13AlgoliaSearch5Index")
...
/// note:
/// If the object does not exist, it will be created. You can avoid automatic creation of the object by
/// passing <code>false</code> to <code>createIfNotExists</code> in <code>partialUpdateObject(_:withID:createIfNotExists:completionHandler:)</code>.
/// \param partialObject New values/operations for the object.
///
...
/// \param objectID Identifier of object to be updated.
///
/// \param createIfNotExists Whether an update on a nonexistent object ID should create the object.
///
/// \param completionHandler Completion handler to be notified of the request’s outcome.
///
///
...
/// note:
/// If an object does not exist, it will be created. You can avoid automatic creation of objects by
/// passing <code>false</code> to <code>createIfNotExists</code> in <code>partialUpdateObjects(_:createIfNotExists:completionHandler:)</code>.
/// \param objects New values/operations for the objects. Each object must contain an <code>objectID</code> attribute.
///
/// \param completionHandler Completion handler to be notified of the request’s outcome.
///
///
...
/// Please refer to our <a href="https://www.algolia.com/doc/swift#index-settings">API documentation</a> for the list of
/// supported settings.
...
/// \param settings New settings.
///
/// \param forwardToReplicas When true, the change is also applied to replicas of this index.
///
/// \param completionHandler Completion handler to be notified of the request’s outcome.
///
///
...
SWIFT_CLASS("_TtC13AlgoliaSearch10IndexQuery")
...
/// Used in geo-search.
SWIFT_CLASS("_TtC13AlgoliaSearch6LatLng")
...
SWIFT_CLASS("_TtC13AlgoliaSearch14LibraryVersion")
...
@interface NSError (SWIFT_EXTENSION(AlgoliaSearch))
...
- (BOOL)isTransient SWIFT_WARN_UNUSED_RESULT;
@end


@interface NSObject (SWIFT_EXTENSION(AlgoliaSearch))
@end

@class PlacesQuery;

/// Client for <a href="https://community.algolia.com/places/">Algolia Places</a>.
SWIFT_CLASS("_TtC13AlgoliaSearch12PlacesClient")
...
SWIFT_CLASS("_TtC13AlgoliaSearch11PlacesQuery")
...
SWIFT_CLASS("_TtC13AlgoliaSearch5Query")
...
SWIFT_CLASS("_TtC13AlgoliaSearch7Request")
@interface Request : AsyncOperationWithCompletion
/// The client to which this request is related.
@property (nonatomic, readonly, strong) AbstractClient * _Nonnull client;
/// Hosts to which the request will be sent.
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull hosts;
/// Index of the first host that will be tried.
@property (nonatomic, readonly) NSInteger firstHostIndex;
/// Index of the next host to be tried.
@property (nonatomic) NSInteger nextHostIndex;
...
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nullable jsonBody;
/// Timeout for individual network queries.
@property (nonatomic, readonly) NSTimeInterval timeout;
/// Timeout to be used for the next query.
@property (nonatomic) NSTimeInterval nextTimeout;
...
@interface NSURLSession (SWIFT_EXTENSION(AlgoliaSearch))
@end
